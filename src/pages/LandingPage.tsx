    ...
    <div className="relative overflow-hidden">
      ...
      <nav className="absolute top-0 w-full z-50 px-6 py-8 flex justify-between items-center max-w-7xl left-1/2 -translate-x-1/2">
        <div className="flex items-center gap-2">
          <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-plaeen-green text-black font-bold text-xl">
            P
          </div>
        ...
        <Link to="/auth">
          <Button
            variant="ghost"
            className="text-[10px] font-bold uppercase tracking-[0.2em] text-white/60 hover:text-plaeen-green hover:bg-white/5 px-6"
          >
      ...
      <section className="relative flex min-h-[100vh] flex-col items-center justify-center px-6 pt-20 text-center">
        ...
        >
          ...
          <h1 className="text-6xl font-bold leading-[0.9] tracking-tighter md:text-9xl uppercase">
          ...
          >
            ...
            <Button
              type="submit"
              size="lg"
              className="w-full sm:w-auto px-12 py-8 text-xl font-bold uppercase tracking-widest shadow-[0_0_30px_rgba(118,233,0,0.3)] hover:shadow-[0_0_50px_rgba(118,233,0,0.5)] transition-all"
            >
              Get started
            </Button>
          </form>
      ...
      <section className="mx-auto max-w-4xl px-6 py-32">
        <h2 className="text-5xl font-bold text-white uppercase tracking-tighter text-center mb-16">
      ...
      <section className="mx-auto max-w-7xl px-6 py-40 text-center relative">
        ...
        <h2 className="text-6xl font-bold uppercase tracking-tighter mb-6">
          Ready to end the screen time battle?
        </h2>
        <p className="text-white/40 font-bold uppercase tracking-[0.3em] mb-12">
        ...
        >
          ...
          <Button
            type="submit"
            size="lg"
            className="w-full sm:w-auto px-12 py-8 text-xl font-bold uppercase tracking-widest shadow-[0_0_30px_rgba(118,233,0,0.3)]"
          >
            Get started
          </Button>
        </form>
