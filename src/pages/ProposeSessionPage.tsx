            ...
            <Card className="bg-white/5 border-white/10 p-8 space-y-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-lg font-bold text-white uppercase">
                    {day
                      ? format(new Date(day.replace(/-/g, "/")), "EEEE, MMM d")
                      : ""}
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-lg font-bold text-white uppercase">
                    {hour}:00{" "}
                    <span className="text-white/20 text-xs ml-1">(Local)</span>
                  </p>
                </div>
              </div>
            </Card>
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      selectedGame?.id === game.id
                        ? "bg-plaeen-green border-plaeen-green shadow-[0_0_30px_rgba(118,233,0,0.3)]"
