    ...
    return (
      <div className="min-h-screen bg-plaeen-dark flex items-center justify-center p-6">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-white/40 font-bold uppercase tracking-widest text-xs">Decrypting Protocol...</p>
        </div>
      </div>
    );
  }
        ...
        <Card className="bg-plaeen-purple/20 border-white/10 p-10 backdrop-blur-2xl">
          {isSuccess ? (
            <div className="text-center space-y-8">
              ...
              <div>
                <h2 className="text-3xl font-bold text-white uppercase tracking-tighter mb-2">PIN <span className="text-plaeen-green">Updated</span></h2>
                <p className="text-white/40 text-[10px] font-bold uppercase tracking-[0.3em]">Access protocols have been reset</p>
              </div>
              <p className="text-white/60 text-sm font-medium leading-relaxed">
                Your new parental PIN has been successfully saved to the encrypted mainframe. You can now access your profile.
              </p>
              <Button 
            ...
            <div className="text-center space-y-8">
              <Shield size={64} className="text-red-500 mx-auto" opacity={0.5} />
              <div>
                <h2 className="text-3xl font-bold text-white uppercase tracking-tighter mb-2">Protocol <span className="text-red-500">Error</span></h2>
                <p className="text-white/40 text-[10px] font-bold uppercase tracking-[0.3em]">Security breach or timeout</p>
              </div>
            ...
            <div className="space-y-10">
              <div className="text-center">
                ...
                <h2 className="text-3xl font-bold text-white uppercase tracking-tighter mb-2">New <span className="text-plaeen-green">PIN</span></h2>
                <p className="text-white/40 text-[10px] font-bold uppercase tracking-[0.3em]">Configure administrative access</p>
              </div>

              <form onSubmit={handleReset} className="space-y-8">
                <div className="space-y-6">
                  <div className="space-y-2">
                    <label className="text-[10px] font-bold text-plaeen-green uppercase tracking-[0.4em] ml-1">New 4-Digit PIN</label>
                    <input 
                      type="password"
                      maxLength={4}
                      value={newPin}
                  ...
                  <div className="space-y-2">
                    <label className="text-[10px] font-bold text-plaeen-green uppercase tracking-[0.4em] ml-1">Confirm PIN</label>
                    <input 
                      type="password"
                      maxLength={4}
                      value={confirmPin}
