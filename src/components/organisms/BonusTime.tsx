      ...
      <Card className="bg-white/5 border-white/10 p-8 space-y-10">
        <div>
          ...
          <Button
            ...
            disabled={isSaving}
            variant="outline"
            className="w-full border-plaeen-green/30 text-plaeen-green font-bold uppercase  text-[10px] py-4 hover:bg-plaeen-green/10"
          >
        ...
        <div className="pt-8 border-t border-white/5">
          <Button
            ...
            variant="outline"
            className="w-full border-white/10 text-white/40 hover:text-plaeen-green hover:border-plaeen-green/30 font-bold uppercase  text-[10px] py-6"
          >
            <RefreshCw size={14} className="mr-2" /> Reset Daily Allowance
          </Button>
          <p className="text-[8px] text-white/20 font-bold uppercase  mt-3 text-center">
